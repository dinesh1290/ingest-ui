...
export class SchemaService {
  ...
  initializeSchemaFields(){
    if(Object.keys(this.fields)){
      for(let schemaType of this.SCHEMA_TYPES){
        ...
        this.recurseSchemaFields(this.fields[schemaTypeKey],'', schemaId);
      }
    }
  }
  ...
  */
  ...
  getFieldsOfSchemaType(schemaType){
    return this.fields[schemaType]
  }

  getSchemaId(schemaType):string{
    return this.fields[schemaType]['describedBy'];
  }
